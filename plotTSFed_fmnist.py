...
TSFed = pd.read_csv("TSFed/tsfed_fmnist_thesis.txt", sep=";", names=["time","evaltime","precision","recall","f1-score","loss_distributed","loss_centralized","accuracy_centralize","accuracy_distributed", "-",],)
FedAvg = pd.read_csv("Baseline/baseline_FMNIST_fedAvg.txt", sep=";", names=["time","evaltime","precision","recall","f1-score","loss_distributed","loss_centralized","accuracy_centralize","accuracy_distributed", "-",],)
FedAvgLoss = pd.read_csv("Baseline/baseline_FMNIST_fedAvgLoss.txt", sep=";", names=["time","evaltime","precision","recall","f1-score","loss_distributed","loss_centralized","accuracy_centralize","accuracy_distributed", "-",],)
FedACS = pd.read_csv("Baseline/baseline_FMNIST_fedAvgAcc.txt", sep=";", names=["time","evaltime","precision","recall","f1-score","loss_distributed","loss_centralized","accuracy_centralize","accuracy_distributed", "-",],)
FedOpt = pd.read_csv("Baseline/baseline_FMNIST_fedOpt.txt", sep=";", names=["time","evaltime","precision","recall","f1-score","loss_distributed","loss_centralized","accuracy_centralize","accuracy_distributed", "-",],)
FedYogi = pd.read_csv("Baseline/baseline_FMNIST_fedYogi.txt", sep=";", names=["time","evaltime","precision","recall","f1-score","loss_distributed","loss_centralized","accuracy_centralize","accuracy_distributed", "-",],)
FedTrim = pd.read_csv("Baseline/baseline_FMNIST_fedTrimMedAvg.txt", sep=";", names=["time","evaltime","precision","recall","f1-score","loss_distributed","loss_centralized","accuracy_centralize","accuracy_distributed", "-",],)
FedMed = pd.read_csv("Baseline/baseline_FMNIST_fedMedian.txt", sep=";", names=["time","evaltime","precision","recall","f1-score","loss_distributed","loss_centralized","accuracy_centralize","accuracy_distributed", "-",],)
...
ax1.axhline(y = 60, color = 'tab:cyan', linestyle = 'dashdot', linewidth=1,) 
...
ax1.set_title("Comparative - FMNIST")
...
ax2.axhline(y = 60, color = 'tab:cyan', linestyle = 'dashdot', linewidth=1,) 
...
plt.savefig('tsfed_fmnist.png',bbox_inches='tight',  dpi=700)	#save image
